...
st.set_page_config(
    page_title="11673 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Vina</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    # Direktori tempat penyimpanan ketiga model
    model_directory = r'C:/Users/vina qhurotu aini/Downloads/Unsupervised Learning (Praktek)/Unsupervised Learning (Praktek)/Tugas4_B_11673'
    model_path = {
    ...
    # Sidebar untuk memasukkan nilai untuk titik baru
